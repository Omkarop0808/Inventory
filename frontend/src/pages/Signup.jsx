    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Start managing your homestay today</p>
          </div>
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-20 text-white text-center p-12 max-w-lg">
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-extrabold mb-6 tracking-tight">Join Mezenga Today</h2>
          <p className="text-lg text-white/70 font-medium">Everything you need to run your homestay, all in one premium platform.</p>
        </div>
      </div>
    </div>
  );
